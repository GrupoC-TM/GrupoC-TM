...
def Borrar_en_DB(pid):
        ...
        try:
            ...
            tkinter.messagebox.showinfo("","ID de la orden:  "+str(pid)+" ha sido candelada!")
        ...
        #a otra tabla (Estado) para que el usuario vea el estado del pedido.
            ...
            try:
                ...
                tkinter.messagebox.showinfo("","ID de la orden:  "+str(pid)+" ha sido cancelada!")
...
def track_pedido():
        ...
        def traerEstado(id):
            ...
            if(validador==FALSE):
                    tkinter.messagebox.showinfo("","No existe ningun pedido con el id :  "+str(id))
